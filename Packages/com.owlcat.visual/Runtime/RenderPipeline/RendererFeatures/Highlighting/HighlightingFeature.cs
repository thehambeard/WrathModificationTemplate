...
namespace Owlcat.Runtime.Visual.RenderPipeline.RendererFeatures.Highlighting
{
	...
	public class HighlightingFeature : ScriptableRendererFeature
	{
		...
		{
			[Reload("Hidden/Owlcat/Highlight/Highlighter", ReloadAttribute.Package.Builtin)]
			public Shader HighlighterShader;

			[Reload("Hidden/Owlcat/Highlight/Blur", ReloadAttribute.Package.Builtin)]
			public Shader BlurShader;

			[Reload("Hidden/Owlcat/Highlight/Cut", ReloadAttribute.Package.Builtin)]
			public Shader CutShader;

			[Reload("Hidden/Owlcat/Highlight/Composite", ReloadAttribute.Package.Builtin)]
