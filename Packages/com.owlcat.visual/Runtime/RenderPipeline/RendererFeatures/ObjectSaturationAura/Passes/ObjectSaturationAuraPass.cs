...
namespace Owlcat.Runtime.Visual.RenderPipeline.RendererFeatures.ObjectSaturationAura.Passes
{
	public class ObjectSaturationAuraPass : ScriptableRenderPass
	{
		...
		private static readonly int _SaturationStrength = Shader.PropertyToID("_SaturationStrength");

		private static readonly int _SaturationPower = Shader.PropertyToID("_SaturationPower");

		public override string Name => "Object Saturation Aura Pass";
		...
		public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
		{
			...
			CommandBuffer commandBuffer = CommandBufferPool.Get("Object Saturation Aura Pass");
