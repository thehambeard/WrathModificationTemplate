...
namespace Owlcat.Runtime.Visual.RenderPipeline.RendererFeatures.OccludedObjectHighlighting
{
	...
	public class OccludedObjectHighlightingFeature : ScriptableRendererFeature
	{
		...
		{
			[SerializeField]
			[Reload("Hidden/Owlcat/OccludedObject", ReloadAttribute.Package.Builtin)]
			public Shader OccludedObjectShader;

			[SerializeField]
			[Reload("Hidden/Owlcat/BakeNoise3D", ReloadAttribute.Package.Builtin)]
		...
		[SerializeField]
		[Reload("Assets/Code/Owlcat/Runtime/Visual/RenderPipeline/RendererFeatures/OccludedObjectHighlighting/OccludedObjectWithInstancing.mat", ReloadAttribute.Package.Builtin)]
