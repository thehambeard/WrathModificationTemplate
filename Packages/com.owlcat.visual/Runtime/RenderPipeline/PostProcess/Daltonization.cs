...
namespace Owlcat.Runtime.Visual.RenderPipeline.PostProcess
{
	...
	public class Daltonization : VolumeComponent, IPostProcessComponent
	{
		...
		public ClampedFloatParameter BrightnessFactor = new ClampedFloatParameter(0f, 0f, 1f);

		public ClampedFloatParameter ContrastFactor = new ClampedFloatParameter(0f, 0f, 1f);
