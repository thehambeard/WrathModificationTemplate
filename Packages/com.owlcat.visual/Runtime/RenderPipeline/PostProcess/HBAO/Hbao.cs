...
namespace Owlcat.Runtime.Visual.RenderPipeline.PostProcess.HBAO
{
	...
	public class Hbao : VolumeComponent, IPostProcessComponent
	{
		...
		public QualityParameter Quality = new QualityParameter(Owlcat.Runtime.Visual.RenderPipeline.PostProcess.HBAO.Quality.Medium);

		[Tooltip("The deinterleaving factor.")]
		public DeinterleavingParameter Deinterleaving = new DeinterleavingParameter(Owlcat.Runtime.Visual.RenderPipeline.PostProcess.HBAO.Deinterleaving.Disabled);

		[Tooltip("The resolution at which the AO is calculated.")]
		public ResolutionParameter Resolution = new ResolutionParameter(Owlcat.Runtime.Visual.RenderPipeline.PostProcess.HBAO.Resolution.Full);

		[Tooltip("The type of noise to use.")]
		public NoiseTypeParameter NoiseType = new NoiseTypeParameter(Owlcat.Runtime.Visual.RenderPipeline.PostProcess.HBAO.NoiseType.Dither);
