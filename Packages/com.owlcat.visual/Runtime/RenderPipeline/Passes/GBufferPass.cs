...
namespace Owlcat.Runtime.Visual.RenderPipeline.Passes
{
	public class GBufferPass : ScriptableRenderPass
	{
		...
		public override string Name => "GBuffer Pass";
		...
		{
			CommandBuffer commandBuffer = CommandBufferPool.Get("GBuffer Pass");
			...
			IndirectRenderingSystem.Instance.DrawPass(ref context, ref renderingData, "GBUFFER", m_FilteringSettings);
		}
	}
}
