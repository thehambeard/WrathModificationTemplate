...
namespace Owlcat.Runtime.Visual.RenderPipeline.Passes
{
	public class HbaoPass : ScriptableRenderPass
	{
		...
		public override string Name => "Draw HBAO";
		...
		public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
		{
			...
			CommandBuffer cmd = CommandBufferPool.Get("Draw HBAO");
		...
		protected void UpdateShaderProperties(ref RenderingData renderingData)
		{
			...
			_renderTarget.downsamplingFactor = ((m_Settings.Resolution.value == Owlcat.Runtime.Visual.RenderPipeline.PostProcess.HBAO.Resolution.Full) ? 1 : ((m_Settings.Resolution.value == Owlcat.Runtime.Visual.RenderPipeline.PostProcess.HBAO.Resolution.Half) ? 2 : 4));
			...
			float num = Mathf.Tan(0.5f * camera.fieldOfView * ((float)Math.PI / 180f));
