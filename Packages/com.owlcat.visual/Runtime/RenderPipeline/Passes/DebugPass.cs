...
namespace Owlcat.Runtime.Visual.RenderPipeline.Passes
{
	public class DebugPass : ScriptableRenderPass
	{
		...
		public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
		{
			...
			{
				CommandBuffer commandBuffer4 = CommandBufferPool.Get("Debug Buffer");
			...
			{
				CommandBuffer commandBuffer2 = CommandBufferPool.Get("Debug Buffer");
			...
			{
				CommandBuffer commandBuffer3 = CommandBufferPool.Get("Debug Buffer");
			...
			{
				CommandBuffer commandBuffer = CommandBufferPool.Get("Debug Buffer");
			...
			{
				CommandBuffer commandBuffer6 = CommandBufferPool.Get("Cluster Heatmap Debug");
			...
			{
				CommandBuffer commandBuffer5 = CommandBufferPool.Get("Cluster Heatmap Debug");
			...
			{
				CommandBuffer commandBuffer8 = CommandBufferPool.Get("Debug Overdraw");
				using (new ProfilingScope(commandBuffer8, m_DebugOverdrawProfilingSampler))
				{
					...
					IndirectRenderingSystem.Instance.DrawPass(ref context, ref renderingData, "DEBUG ADDITIONAL", m_FilteringSettingsTransparent);
					...
					IndirectRenderingSystem.Instance.DrawPass(ref context, ref renderingData, "DEBUG ADDITIONAL", m_FilteringSettingsOpaque);
			...
			{
				CommandBuffer commandBuffer7 = CommandBufferPool.Get("Debug Overdraw");
				using (new ProfilingScope(commandBuffer7, m_DebugOverdrawProfilingSampler))
				{
					...
					IndirectRenderingSystem.Instance.DrawPass(ref context, ref renderingData, "DEBUG ADDITIONAL", m_FilteringSettingsAll);
			...
			{
				CommandBuffer commandBuffer10 = CommandBufferPool.Get("Cluster Heatmap Debug");
			...
			{
				CommandBuffer commandBuffer9 = CommandBufferPool.Get("Cluster Heatmap Debug");
