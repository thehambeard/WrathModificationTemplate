...
namespace Owlcat.Runtime.Visual.RenderPipeline.Passes
{
	public class ShadowCasterPass : ScriptableRenderPass
	{
		...
		public override string Name => "ShadowCasterPass";
		...
		{
			CommandBuffer commandBuffer = CommandBufferPool.Get("Draw Shadows");
			using (new ProfilingScope(commandBuffer, m_ProfilingSampler))
			{
				...
				{
					ShadowDrawingSettings settings = new ShadowDrawingSettings(renderingData.CullResults, 0);
