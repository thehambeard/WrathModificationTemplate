...
namespace Owlcat.Runtime.Visual.RenderPipeline.Passes
{
	public class BeforeTransparentPostProcessPass : ScriptableRenderPass
	{
		...
		public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
		{
			...
			CommandBuffer cmd = CommandBufferPool.Get("Before Transparent Post Process Pass");
			...
			using (new ProfilingScope(cmd, m_ProfilingSampler))
			{
				...
				if (m_SaturationOverlay.IsActive() && !renderingData.CameraData.DisabledRendererFeatures.Contains("ObjectSaturationAuraFeature"))
				{
