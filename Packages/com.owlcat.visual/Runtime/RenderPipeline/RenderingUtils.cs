...
namespace Owlcat.Runtime.Visual.RenderPipeline
{
	public static class RenderingUtils
	{
		...
		private static readonly int unity_SpecCube0 = Shader.PropertyToID("unity_SpecCube0");

		private static readonly int unity_SpecCube0_HDR = Shader.PropertyToID("unity_SpecCube0_HDR");
		...
		{
			float num = ((!camera.orthographic) ? (2f * distance * Mathf.Tan(camera.fieldOfView * 0.5f * ((float)Math.PI / 180f))) : (camera.orthographicSize * 2f));
