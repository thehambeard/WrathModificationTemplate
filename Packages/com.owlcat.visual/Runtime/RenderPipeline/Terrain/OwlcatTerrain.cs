...
namespace Owlcat.Runtime.Visual.RenderPipeline.Terrain
{
	...
	public class OwlcatTerrain : MonoBehaviour
	{
		...
		private static readonly int _TerrainLayerMasksScale = Shader.PropertyToID("_TerrainLayerMasksScale");

		private static readonly int _TerrainLayerUvMatrix = Shader.PropertyToID("_TerrainLayerUvMatrix");

		private static readonly int _TerrainLayerParams = Shader.PropertyToID("_TerrainLayerParams");

		private static readonly int _DiffuseArray = Shader.PropertyToID("_DiffuseArray");

		private static readonly int _NormalArray = Shader.PropertyToID("_NormalArray");

		private static readonly int _MasksArray = Shader.PropertyToID("_MasksArray");

		private static readonly int _ControlTexturesCount = Shader.PropertyToID("_ControlTexturesCount");

		private static readonly int _SplatArray = Shader.PropertyToID("_SplatArray");

		private static readonly int _TerrainMaxHeight = Shader.PropertyToID("_TerrainMaxHeight");
