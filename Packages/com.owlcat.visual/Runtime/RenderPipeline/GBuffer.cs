...
namespace Owlcat.Runtime.Visual.RenderPipeline
{
	public class GBuffer
	{
		...
		private RenderTargetIdentifier[] m_DeferredGBuffer = new RenderTargetIdentifier[6];
		...
		public void Initialize(RenderPath renderPath, ScriptableRenderContext context, ref RenderingData renderingData, bool deferredUseCompute)
		{
			...
			if (renderPath == RenderPath.Deferred)
			{
				...
				{
					cameraTargetDescriptor3.enableRandomWrite = true;
				}
				...
				cameraTargetDescriptor4.sRGB = false;
				cameraTargetDescriptor4.colorFormat = RenderTextureFormat.ARGB32;
				commandBuffer.GetTemporaryRT(m_CameraTranslucencyRT.Id, cameraTargetDescriptor4, FilterMode.Point);
			...
			if (renderPath == RenderPath.Deferred && renderingData.CameraData.IsDecalsEnabled && renderingData.CameraData.IsScreenSpaceReflectionsEnabled)
			{
				cameraTargetDescriptor5.enableRandomWrite = true;
			}
			commandBuffer.GetTemporaryRT(m_CameraNormalsRt.Id, cameraTargetDescriptor5, FilterMode.Bilinear);
			...
			cameraTargetDescriptor6.graphicsFormat = GraphicsFormat.B10G11R11_UFloatPack32;
			cameraTargetDescriptor6.sRGB = false;
			commandBuffer.GetTemporaryRT(m_CameraBakedGIRt.Id, cameraTargetDescriptor6, FilterMode.Point);
			...
			cameraTargetDescriptor7.colorFormat = RenderTextureFormat.ARGB32;
			commandBuffer.GetTemporaryRT(m_CameraShadowmaskRT.Id, cameraTargetDescriptor7, FilterMode.Point);
			...
			m_DeferredGBuffer[1] = m_CameraNormalsRt.Identifier();
			m_DeferredGBuffer[2] = m_CameraColorRt.Identifier();
			m_DeferredGBuffer[3] = m_CameraBakedGIRt.Identifier();
			m_DeferredGBuffer[4] = m_CameraShadowmaskRT.Identifier();
			m_DeferredGBuffer[5] = m_CameraTranslucencyRT.Identifier();
